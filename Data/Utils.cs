...
public static class Utils
{
    ...
    {
        return @"/Users/wwwaa/source/repos/BikeRentalSystem/BikeRentalSystem/wwwroot/JsonData";
    ...
    {
        return Path.Combine(("/Users/wwwaa/source/repos/BikeRentalSystem/BikeRentalSystem/wwwroot/JsonData"),  "inventory.json");
    }    
    
    public static string GetWithdrawlFilePath(Guid userId)
    {
        return Path.Combine(("Users/wwwaa/source/repos/BikeRentalSystem/BikeRentalSystem/wwwroot/JsonData"), "withdrawl.json");
    }   
    
    public static string GetApprovedFilePath(Guid userId)
    {
        return Path.Combine(("/Users/wwwaa/source/repos/BikeRentalSystem/BikeRentalSystem/wwwroot/JsonData"), "approved.json");
    }
